...
class CategoryModel extends ChangeNotifier{
  ...
  Future<void> getCategories() async {
    ...
    var url = Uri.parse('http://studentshopspringbackend-env.eba-b2yvpimm.us-east-1.elasticbeanstalk.com/categories');
  ...
  Future<void> getImageForCategory() async {
    ...
    for (int i = 0; i < categoryList.length; i++) {
        ...
        String urlString = "http://studentshopspringbackend-env.eba-b2yvpimm.us-east-1.elasticbeanstalk.com/categoryImage/$categoryId";
